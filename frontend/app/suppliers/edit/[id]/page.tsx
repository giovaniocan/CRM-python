...
export default function EditSupplierPage({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      await updateSupplier(Number(params.id), formData);
      router.push("/suppliers");
    } catch (error) {
      console.error("Erro ao atualizar fornecedor:", error);
      toast.error(
        "Erro ao atualizar fornecedor. Verifique os dados e tente novamente."
      );
    }
  };
    ...
    <div className="bg-linear-to-br from-gray-50 via-white to-green-50/30">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-4">
          ...
          <p className="text-gray-600">Atualize as informações do fornecedor</p>
        </div>
