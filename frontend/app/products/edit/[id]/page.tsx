...
export default function EditProductPage({
  ...
  // Desembrulha a Promise de params (padrão do Next.js 15)
  const { id } = use(params);
    ...
    <div className="bg-linear-to-br from-gray-50 via-white to-orange-50/30">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-4">
          ...
          <p className="text-gray-600">Atualize as informações do item</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="text-sm text-gray-500">
              <span className="font-medium">Dica:</span> Altere apenas o
              necessário
            </div>
